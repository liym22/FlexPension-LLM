#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Fit two-stage Probit models for participation and pension channel choice.

The 30-case screening sample is excluded. The script writes model summaries
and serialized fitted models for both stages.
"""
...
print("=" * 80)
print("Step 3: Probit regression")
print("=" * 80)
...
print(f"Loaded regression_data.csv: {len(reg)} records")
...
# Define predictors.
# Continuous and ordinal predictors.
BASE_VARS = [
    'age',
    'gender', 'education', 'health',
    # Hukou-type indicators.
    'hukou_agri', 'hukou_uni', 'hukou_else',
    # Province indicators, with Guangdong Province as reference.
    'hukou_beijing', 'hukou_tianjin', 'hukou_hebei', 'hukou_shanxi',
    'hukou_neimenggu', 'hukou_liaoning', 'hukou_jilin', 'hukou_heilongjiang',
    'hukou_shanghai', 'hukou_jiangsu', 'hukou_zhejiang', 'hukou_anhui',
    'hukou_fujian', 'hukou_jiangxi', 'hukou_shandong', 'hukou_henan',
    'hukou_hubei', 'hukou_hunan',
    'hukou_guangxi', 'hukou_hainan', 'hukou_chongqing', 'hukou_sichuan',
    'hukou_guizhou', 'hukou_yunnan', 'hukou_xizang',
    'hukou_shaanxi', 'hukou_gansu', 'hukou_qinghai', 'hukou_ningxia',
    'hukou_xinjiang', 'hukou_hongkong',
    # Migration.
    'floating',
...
def run_probit(df_train, y_col, x_cols, label):
    ...
    df_clean = df_train[x_cols + [y_col]].dropna(subset=[y_col])
    ...
    if 'age' in used_cols:
        ...
        # Regress residuals on age and age squared.
        ...
        # Two-sided t test for the squared-age coefficient.
        resid_hat = A @ ols_res
