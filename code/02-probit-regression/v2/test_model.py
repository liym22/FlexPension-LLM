#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Evaluate both version 2 Probit stages on the held-out sample.
...
print("=" * 80)
print("Step 4 (v2): Probit model evaluation")
print("=" * 80)
...
report_lines.append("Step 4 (v2) evaluation results")
report_lines.append("=" * 80)
...
cr1 = classification_report(y_true1, y_pred1,
                            target_names=['Non-participant (0)', 'Participant (1)'])
